...
let Korisnik = exports.Korisnik = class Korisnik {
};
__decorate([
...
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], Korisnik.prototype, "password", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", Number)
], Korisnik.prototype, "virtuelniNovac", void 0);
__decorate([
    (0, typeorm_1.Column)({ unique: true }),
    __metadata("design:type", Number)
], Korisnik.prototype, "timId", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => tim_entity_1.Tim),
    (0, typeorm_1.JoinColumn)({ name: 'timId' }),
    __metadata("design:type", tim_entity_1.Tim)
], Korisnik.prototype, "tim", void 0);
exports.Korisnik = Korisnik = __decorate([
    (0, typeorm_1.Entity)('korisnici')
], Korisnik);
